...
try{
    ...
    Copy-Item -Path "Powerpoint_template.potx" -Destination "$env:APPDATA\Microsoft\Excel\XLSTART\Book.potx" -Recurse -Force
    Copy-Item -Path "Powerpoint_template.potx" -Destination "$env:APPDATA\Microsoft\Excel\XLSTART\Sheet.potx" -Recurse -Force
